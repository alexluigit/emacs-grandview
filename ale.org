...
(use-package ale-fonts
  ...
  (setq ale/zh-fonts '("WenQuanYi Micro Hei"))
...
(use-package ale-window
  ...
  :defer t
  :bind
  ("s-n" . ale/window-move-next)
  ("s-p" . ale/window-move-prev))
#+end_src
...
(use-package ale-eshell
  :straight nil
  :commands ale/eshell-toggle-bottom
  :defer t
  :config
...
(use-package ale-files
  ...
  (:map
   ...
   ("M-<return>" . ale/files-other-window)
   :map
   ale/files-map
   ("." . ale/files-dotfiles)
...
(use-package lf
  ...
  :bind (:map lf-mode-map ("s-e" . ale/eshell-toggle-bottom))
  :init
