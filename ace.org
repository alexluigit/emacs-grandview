...
(use-package ace-simple
  ...
  (("s-s" . scroll-up)
   ...
   ("C-c C-M-d" . ace/simple-insert-date)
   ("C-c C-M-e" . ace/simple-escape-url)
   ("C-c C-M-q" . ace/simple-unfill-region-or-paragraph)
   ("C-c C-M-r" . ace/simple-rename-file-and-buffer)
   ("C-c C-M-=" . count-words)
...
*** COMMENT Regular expressions (re-builder.el)
...
(use-package consult
  ...
  ("M-s r" . consult-consult-register)
  ("M-s k" . consult-yank)
...
The =ace/scratch-buffer-setup= simply adds some text in the buffer and
...
(use-package ace-eshell
  ...
  :bind
  (("s-e" . ace/eshell-toggle)
   :map eshell-mode-map
   ("C-r" . consult-history)
   ("C-u" . eshell-kill-input)
   ("C-n" . eshell-next-prompt)
   ("C-p" . eshell-previous-prompt)
   ("s-<backspace>" . ace/eshell-clear-buffer)
   ("s-c" . ace/eshell-new)
   ("s-i" . ace/eshell-next)
   ("s-o" . ace/eshell-prev)))
#+end_src
...
(use-package lf
  ...
  :init
  (setq lf-routes '(("h" "Home"        "~")
                    ("u" "Emacs cache" "~/.cache/emacs")
                    ("c" "Code"        "~/Code")
                    ("d" "Downloads"   "~/Downloads")
                    ("p" "Wallpaper"   "~/Pictures/wallpaper")
                    ("m" "Drives"      "/media")
...
(use-package nov
  ...
  (add-hook 'nov-mode-hook 'ace/nov-setup)
  :config
...
(use-package ace-project
  :straight nil
  :config
  (setq ace/project-project-roots '("~/Code/" "~/"))
  (setq ace/project-commit-log-limit 25)
  (setq ace/project-large-file-lines 1000)
  :bind
  ("C-x p DEL" . ace/project-remove-project)
  ("C-x p l" . ace/project-commit-log)
  ("C-x p m" . ace/project-magit-status)
  ("C-x p s" . ace/project-find-subdir)
  ("C-x p t" . ace/project-retrieve-tag))
#+end_src
...
(use-package lsp-mode
  ...
  :hook
  ((sh-mode lua-mode haskell-mode ace/vue-mode typescript-mode) . #'lsp-deferred))
