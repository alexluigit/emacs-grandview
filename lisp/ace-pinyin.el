��炻謚鰣豕貰鈰螫舐筮鯴釃手受收首授守售瘦壽獸狩綬艏書數術屬輸樹述熟束署殊舒叔鼠疏淑抒薯梳暑豎蜀恕墅孰漱樞贖黍蔬曙倏庶戍塾澍姝紓秫毹殳疋菽沭攄腧刷耍唰率衰摔甩帥蟀涮栓拴閂雙爽霜孀瀧水誰稅睡順舜瞬吮說朔碩爍鑠妁蒴槊搠似忪嗽綏嗍"
    "紮咋贓鍺奘咋炸紮咋詐乍眨渣劄柵軋閘榨喳摣柞楂哳咤鍘砟齇咤痄蚱摘債宅窄齋寨翟砦瘵戰展站占沾斬輾粘盞嶄瞻綻蘸湛詹氈棧譫搌旃長張章丈掌漲帳障賬脹仗杖彰璋蟑樟瘴漳嶂鄣獐仉幛嫜著找照招朝趙召罩兆昭肇沼詔釗啁棹笊這著者折哲浙遮轍輒謫蔗蟄褶鷓鍺磔摺蜇赭柘真陣鎮震針珍圳振診枕斟貞偵賑甄臻箴疹砧楨縝畛軫胗稹禎湞溱蓁椹榛朕鴆政正證整爭征掙鄭癥睜徵蒸怔箏拯錚崢猙諍鯖鉦幀之只知至製直治指支誌職致值織紙止質執智置址枝秩植旨滯徵幟稚摯汁擲殖芝吱肢脂峙侄窒蜘趾炙痔咫芷櫛枳躑桎帙梔祉輊贄痣豸卮軹埴陟郅黹忮彘騭酯摭縶跖膣雉鷙胝蛭躓祗觶中種重眾終鐘忠衷腫仲鍾踵盅冢忪舯螽周州洲粥舟皺驟軸宙咒晝肘帚胄紂謅縐妯碡啁葤籀繇酎主住註助著逐諸朱駐珠祝豬築竹煮囑柱燭鑄株矚蛛佇拄貯洙誅褚銖箸蛀茱炷躅竺杼翥渚瀦麈櫧櫫苧侏瘃疰邾舳抓爪拽嘬傳專轉賺撰磚篆囀饌顓裝狀壯莊撞妝幢樁奘僮戇追墜綴錐贅隹椎惴騅縋準諄窀肫著桌捉卓琢灼酌拙濁濯茁啄斫鐲涿焯浞倬禚諑擢吱騶賺琢柞嘬唑"
...
(defcustom ace/pinyin-simplified-char-table 'ace/pinyin-xiaohe-char-table-simp
  "ASCII char to simplifed Chinese characters.")

(defcustom ace/pinyin-traditional-char-table 'ace/pinyin-xiaohe-char-table-trad
  "ASCII char to tranditional Chinese characters.")

(defvar ace/pinyin--punctuation-alist
  '((?. . "[。.]")
    (?, . "[，,]")
    (?? . "[？?]")
    (?: . "[：:]")
...
(defun ace/pinyin-build-regexp-char
  ...
  (let ((diff (- char ?a))
    ...
    (if (or (>= diff 26) (< diff 0))
        (or (and (not no-punc-p)
                 (assoc-default
                  char
                  ace/pinyin--punctuation-alist))
            (regexp-quote (string char)))
      (setq regexp
            (if mixed-p
                (concat (nth diff (eval ace/pinyin-traditional-char-table))
                        (nth diff (eval ace/pinyin-simplified-char-table)))
              (nth diff
                   (if tranditional-p
                       (eval ace/pinyin-traditional-char-table)
                     (eval ace/pinyin-simplified-char-table)))))
      (if only-chinese-p
          (if (string= regexp "")
              regexp
            (format "[%s]" regexp))
...
(defun ace/pinyin-build-regexp-string
    (str &optional no-punc-p tranditional-p only-chinese-p mixed-p)
  (mapconcat (lambda (c) (ace/pinyin-build-regexp-char
